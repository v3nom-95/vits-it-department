        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="flex items-center mb-4 md:mb-0">
            <Link to="/" className="flex items-center group">
              ...
              <div className="text-left">
                <h1 className="text-department-blue text-3xl font-bold tracking-tight">VIGNAN</h1>
          ...
          <div className="flex items-center">
            <div className="mr-4 hidden md:block">
              <p className="font-heading text-xl text-department-purple">Department of</p>
              <p className="font-heading text-2xl font-bold text-department-dark">Information Technology</p>
            </div>
            <img 
